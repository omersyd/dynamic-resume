...
class LatexDeveloperAgent:
    ...
    async def build_resume(self, job_analysis: str, strategy: str, sample_latex: str, experience: str) -> str:
        system_prompt = """You are an expert LaTeX Developer and Resume Writer.
...
- EXACTLY follow the structure/packages/commands of the Sample LaTeX.
